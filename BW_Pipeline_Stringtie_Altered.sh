...
MyID=aubclsc0338          ## Example: MyID=aubtss
...
REFD=/scratch/AMPHIBIAN24/XTropicalisRefGenome          ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome    # this directory contains the indexed reference genome for the garter snake
